...
final class City_WeatherTests: XCTestCase {
	var viewModel: WeatherViewModel!
	var coordinator: WeatherViewCoordinator!
	...
	override func setUpWithError() throws {
		...
		coordinator = WeatherViewCoordinator(viewModel: viewModel)
	}
	...
	func testGetCurrentWeather() throws {
		...
		coordinator.fetchCurrentWeather(for: city) { weatherInfo in
